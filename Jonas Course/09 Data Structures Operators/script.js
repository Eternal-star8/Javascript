...
console.log(new String('Navi'));
console.log(typeof new String('Navi'));

console.log(typeof new String('Navi').slice(1));
*/
...
// Comparing emails
const email = 'hello@Navi.io';
const loginEmail = '  Hello@Navi.Io \n';
